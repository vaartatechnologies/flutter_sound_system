...
import com.vaartatechnologies.flutter_sound_system.includes.RecordingHelper;
...
public class FlutterSoundSystemPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    if (call.method.equals("getPlatformVersion")) {
      ...
      RecordingHelper.startRecording(call.argument("audioFileNamedPath"));
    } else if (call.method.equals("stopRecording")) {
      result.success(RecordingHelper.stopRecording());
    } else {
